...
if (isset($_POST['btn-trocar'])) {
    ...
    if ($rowsEmail) {
        ...
        if ($trocar_senha->execute()) {
            ...
            $mail->addReplyTo('paineldefichas@gmail.com', 'Painel de Gestão');
            ...
            $mail->Body = "
                ...
                <p>Olá, <b>$nome</b>!</p>               
                <p><a href='http://100.110.166.68/painel/login/atualizar.php?chave=$chave'>Clique aqui</a> para alterar sua senha.</p>
                <br>
                <span><i>Caso você não tenha solicitado a alteração de senha, ignore este e-mail.</i></span>
                <br><br>
                <span>---------</span>
                <br>
                <span><b>Painel de Gestão - Soledade/RS</b></span>
                <br>
