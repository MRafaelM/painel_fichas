...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["prioridade"])) {
        if ($_POST["prioridade"] === "Azul") {
            ...
            $concluir_azul = $pdo->prepare("UPDATE chamados SET status = 'Concluido', data_fechamento = :data_fechamento WHERE numero = :numero AND status = 'Aberto' AND prioridade = 'Azul'");
