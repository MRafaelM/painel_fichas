        ...
        <div class="main-panel">
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class="container-fluid">
                    <a class="navbar-brand" href="telefone.php"> Controle dos atendimentos pelo telefone </a>
                    ...
                    <div class="row row-cols-2">
                        <div class="col">
                            <div class="card text-dark" style="border-color: #9370DB;">
                                ...
                                <form id="adicionar" method="post" action="atendimento_externo.php">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h5 style="margin-right: 10px; padding-top: 15px;">Selecione o tipo de
                                                    atendimento:</h5>
                                                <?php
                                                $consulta_tipo = $pdo->prepare("SELECT nome_tipo FROM tipos_atendimentos ORDER BY id_tipo");
                                                $consulta_tipo->execute();
                                                $resultados = $consulta_tipo->fetchAll(PDO::FETCH_ASSOC);
                                                ?>
                                                <select id="tipo_atendimento" name="tipo_atendimento" class="form-control" aria-label="Default select example">
                                                    <option selected>Selecione</option>
                                                    <?php
                                                    foreach ($resultados as $resultado) {
                                                        echo '<option value="' . htmlspecialchars($resultado['nome_tipo']) . '">' . htmlspecialchars($resultado['nome_tipo']) . '</option>';
                                                    }
                                                    ?>
                                                </select>
                                            </div>
