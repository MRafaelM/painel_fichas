        ...
        <div class="navbar navbar-dark bg-dark shadow-sm">
            <div class="container d-flex justify-content-between">
                <a href="https://pmsoledaders.inf.br/painel/site/chamados/" class="navbar-brand d-flex align-items-center">
                    ...
                    <strong>Relatórios do Gestor</strong>
                </a>
    ...
    <main role="main" class="mt-5">
        <div class="container-fluid">
            <div class="d-flex justify-content-between flex-wrap">
                ...
                <div class="col-sm-1 d-inline p-2">
                    <div class="card border-secondary" onclick="window.location.href='../sus/welcome.php';">
                ...
                <div class="col-sm-3 d-inline p-2">
                    <div class="card border-secondary" onclick="window.location.href='diario.php';">
                        <div class="card-content">
                            <h4>Diário</h4>
                            <p>Gerar relatório diário</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 d-inline p-2">
                    <div class="card border-secondary" onclick="window.location.href='semanal.php';">
                        <div class="card-content">
                            <h4>Semanal</h4>
                            <p>Gerar relatório semanal</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 d-inline p-2">
                    <div class="card border-secondary" onclick="window.location.href='mensal.php';">
                        <div class="card-content">
                            <h4>Mensal</h4>
                ...
                <div class="col-sm-2 d-inline p-2">
                    <div class="card border-secondary" onclick="window.location.href='anual.php';">
                        <div class="card-content">
                            <h4>Anual</h4>
                            <p>Gerar relatório anual</p>
                        </div>
                    </div>
                </div>
